...
Description: Handles the conversion from the filtered TEI to JSON
-->
<xsl:stylesheet version="2.0"
    xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xmlns:xtf="http://cdlib.org/xtf"
    xmlns:local="http://localhost/"
    xmlns:cudl="http://cudl.cam.ac.uk/xtf/" exclude-result-prefixes="#all">

    <xsl:output method="text" indent="yes" encoding="UTF-8" media-type="text/json; charset=UTF-8" exclude-result-prefixes="#all" omit-xml-declaration="yes"/>
    ...
    <xsl:template match="/">
        ...
        <xsl:for-each select="xtf-converted/xtf:meta/*[local-name()=$layout/cudl:element/@name] |item/*[local-name()=$layout/cudl:element/@name]">
    ...
    <xsl:variable name="layout">
        ...
        <cudl:element name="descriptiveMetadata" jsontype="array">
            <cudl:element name="part" jsontype="object">
                ...
                <cudl:element name="collection" label="Collection" jsontype="string" />
                ...
                <cudl:element name="originNote" label="Publication" jsontype="string" />
                ...
                <cudl:element name="patrons" label="Patron(s)" jsontype="array" listDisplay="unordered">
                    <cudl:element name="name" linktype="keyword search" jsontype="object">
                        <cudl:element name="fullForm" jsontype="string" />
                        <cudl:element name="shortForm" jsontype="string" />
                        <cudl:element name="authority" jsontype="string" />
                ...
                <cudl:element name="illustrators" label="Illustrator(s)" jsontype="array" listDisplay="unordered">
                    <cudl:element name="name" linktype="keyword search" jsontype="object">
                        <cudl:element name="fullForm" jsontype="string" />
                        <cudl:element name="shortForm" jsontype="string" />
                        <cudl:element name="authority" jsontype="string" />
                ...
                <cudl:element name="signatories" label="Signatories" jsontype="array" listDisplay="unordered">
                    <cudl:element name="name" linktype="keyword search" jsontype="object">
                        <cudl:element name="fullForm" jsontype="string" />
                        <cudl:element name="shortForm" jsontype="string" />
                        <cudl:element name="authority" jsontype="string" />
                ...
                <cudl:element name="censors" label="Censor(s)" jsontype="array" listDisplay="unordered">
                    <cudl:element name="name" linktype="keyword search" jsontype="object">
                        <cudl:element name="fullForm" jsontype="string" />
                        <cudl:element name="shortForm" jsontype="string" />
                        <cudl:element name="authority" jsontype="string" />
                ...
                <cudl:element name="sendingDates" jsontype="array">
                    <cudl:element name="event" jsontype="object">
                        <cudl:element name="type" jsontype="string" />
                        <cudl:element name="dateStart" jsontype="string" />
                        <cudl:element name="dateEnd" jsontype="string" />
                        <cudl:element name="dateDisplay" label="Date of Sending" jsontype="string" />
                    </cudl:element>
                </cudl:element>

                <cudl:element name="receiptDates" jsontype="array">
                    <cudl:element name="event" jsontype="object">
                        <cudl:element name="type" jsontype="string" />
                        <cudl:element name="dateStart" jsontype="string" />
                        <cudl:element name="dateEnd" jsontype="string" />
                        <cudl:element name="dateDisplay" label="Date of Receipt" jsontype="string" />
                    </cudl:element>
                </cudl:element>
                ...
                <cudl:element name="medium" label="Medium" jsontype="string" />
                <cudl:element name="technique" label="Technique(s)" jsontype="string" />
                <cudl:element name="scale" label="Scale" jsontype="string" />
                ...
                <cudl:element name="extents" label="Extent" jsontype="array">
                    <cudl:element name="extent" jsontype="string" />
                </cudl:element>
                ...
                <cudl:element name="projectDescs" label="Project Information" jsontype="array">
                    <cudl:element name="projectDesc" jsontype="string" />
                </cudl:element>
                ...
                <!-- CorrespDesc Context -->
                <cudl:element name="correspContextPrev" label="Prev" jsontype="string" />
                <cudl:element name="correspContextNext" label="Next" jsontype="string" />
